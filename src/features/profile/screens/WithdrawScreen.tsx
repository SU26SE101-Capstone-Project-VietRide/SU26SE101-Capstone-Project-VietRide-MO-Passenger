    ...
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.presetRow}>
          ...
          <TouchableOpacity style={styles.presetBadge} onPress={() => setAmount(balance.toString())}>
        ...
        {paymentMethods.map(method => (
          <TouchableOpacity 
            key={method.id} 
            style={[styles.fundingCard, selectedDest === method.id && styles.fundingCardActive]}
          ...
          >
            ...
            {selectedDest === method.id && <CheckCircle size={24} color={colors.primary} weight="fill" />}
          </TouchableOpacity>
        ))}
