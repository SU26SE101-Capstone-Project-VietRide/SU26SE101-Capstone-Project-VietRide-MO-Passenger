...
const createStyles = (theme: AppTheme) => ({
  routeCard: {
    width: 150,
    position: 'relative',
    backgroundColor: theme.effects.isLiquid ? 'rgba(255, 255, 255, 0.54)' : theme.colors.surface,
    borderWidth: 1,
  ...
  routeVisual: {
    ...
    backgroundColor: theme.effects.isLiquid ? 'rgba(42, 193, 188, 0.12)' : theme.colors.primaryFaded,
  ...
  routeGlow: {
    ...
    height: 92,
    borderRadius: 46,
    backgroundColor: theme.effects.isLiquid ? 'rgba(128, 255, 248, 0.24)' : 'transparent',
  },
  routeLine: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  routeTrack: {
    ...
    backgroundColor: theme.effects.isLiquid ? 'rgba(255, 255, 255, 0.62)' : theme.colors.primaryLight,
  },
  routeBadge: {
